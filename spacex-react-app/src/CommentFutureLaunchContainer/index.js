...
class CommentFutureLaunchContainer extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <CommentFutureLaunchList futureLaunch={this.props.futureLaunch} deleteComment={this.deleteComment} comments={this.state.comments} openEditModal={this.openEditModal} />
